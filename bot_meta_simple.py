# app.py — Bot de Telegram + servidor Flask para Render Web Service
...
def text_handler(m):
    ...
    if step == "line":
        ...
        # Si el usuario envía una URL en vez de archivo
        STATE[cid]["media"] = txt
        bot.send_message(cid, "Perfecto 👍\nAhora escribe el **Título Base** para el anuncio:")
        STATE[cid]["step"] = "title"
...
if __name__ == "__main__":
    ...
    # Levantar servidor web en el puerto que Render asigna
